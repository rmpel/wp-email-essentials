			...
			<div id="email-test" class="postbox">
				...
				<div class="inside cols">
					<div class="inside col">
						...
						$wpes_urls_keys = [
							__( 'Blog settings', 'wpes' ),
							__( 'Site settings', 'wpes' ),
							__( 'Alternative Admins', 'wpes' ),
						];

						$wpes_urls = [
							admin_url( 'options-general.php' ),
							is_multisite() ? network_admin_url( 'settings.php' ) : false,
							add_query_arg( 'page', 'wpes-admins', admin_url( 'admin.php' ) ),
						];
						// This construction is to prevent erroneous WordPress.Arrays.MultipleStatementAlignment.DoubleArrowNotAligned detection.
						$wpes_urls = array_combine( $wpes_urls_keys, $wpes_urls );
				...
				<div class="inside">
					...
					foreach ( $wpes_urls as $wpes_url_name => $wpes_url ) {
						print '<br /><a href="' . esc_attr( $wpes_url ) . '">' . esc_html( $wpes_url_name ) . '</a>';
					}
					print '</em>';
					?>
				</div>
